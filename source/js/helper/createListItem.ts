class ListItemHelper {
    ...
    public createLayerGroupListItem(title: string): HTMLLIElement {
        ...
        li.innerHTML = `<span style="display: flex; justify-content: space-between; align-items: center; width: 100%;"><span data-js-title>${title}</span><span data-js-edit>edit</span></span><div class="line-horizontal arrow-right"></div>`;
        return li;
    }
